  ...
  config = function()
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- to define small helper and utility functioçns so you don't have to repeat yourself.
        ...
        map('K', function()
          vim.lsp.buf.hover { max_width = 100, max_height = 14, border = 'rounded' }
    ...
    vim.lsp.config('clangd', { cmd = { 'clangd', '--fallback-style=webkit' }, init_options = { fallbackFlags = { '--std=c++20' } } })
